...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-FourMongo/SDCycleScrollView.framework"
  install_framework "Pods-FourMongo/SDWebImage.framework"
  install_framework "Pods-FourMongo/SwiftyJSON.framework"
fi
